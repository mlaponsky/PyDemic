...
class SetupForm(Form):
    ...
    char1 = SelectField("Role 1", choices=roles, validators=[DataRequired()])
    char2 = SelectField("Role 1", choices=roles, validators=[DataRequired()])
    char3 = SelectField("Role 1", choices=roles, validators=[DataRequired()])
